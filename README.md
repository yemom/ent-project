...
# Clinic Appointment & Medical Records Management System
...
- `src/main/resources/`:
	...
	- `db/migration/` — Flyway migration scripts (V1__*, V2__*, ...). These are the source-of-truth for production schema changes.
- `src/test/`:
